...
public class Demo {
    ...
    //定义本地git路径
    public static final String LOCALPATH = "D:/data/jgit_test/demo/";
    //.git文件路径
    public static final String LOCALGITFILE = LOCALPATH + ".git";
    //远程仓库地址
    public static final String REMOTEREPOURI = "https://e.coding.net/wowo404/spring-cloud-config/spring-cloud-config.git";
    public static final String REMOTEREPOURI_SSH = "git@e.coding.net:wowo404/spring-cloud-config/spring-cloud-config.git";
    //操作git的用户名
    public static final String USER = "hello-ketty-honey@163.com";
    //密码
    public static final String PASSWORD = "woaini521";
    //git远程仓库服务器ip
    public static final String HOST = "172.16.124.101";
    private static final String PRIVATE_KEY = "C:\\Users\\Administrator.DESKTOP-VR558D9\\.ssh\\id_rsa";
    ...
    public static void setupRepoBySSH() throws GitAPIException {
        final SshSessionFactory sshSessionFactory = new JschConfigSessionFactory() {
            ...
            protected JSch createDefaultJSch(FS fs) throws JSchException {
                ...
                //私钥文件必须是RSA的，不能是OPEN SSH的
                //即私钥文件的第一行的文字是BEGIN RSA PRIVATE KEY
                defaultJSch.addIdentity(PRIVATE_KEY);
                return defaultJSch;
            }
        };
        Git.cloneRepository()
                .setURI(REMOTEREPOURI_SSH)
                .setCloneAllBranches(true)
                .setTransportConfigCallback(transport -> {
                    SshTransport sshTransport = (SshTransport) transport;
                    sshTransport.setSshSessionFactory(sshSessionFactory);
                })
                .setDirectory(new File("D:/data/jgit_test/spring-cloud-config"))
                .call();
    }
