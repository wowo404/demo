...
public class EchoServerFromXML {
    ...
    public static void main(String[] args) {
        ...
        URL resource = EchoServerFromXML.class.getClassLoader().getResource("EchoServer.xml");
        Object[] config = new Object[]{resource.getPath()};
        if (quickServer.initService(config)) {
            try {
